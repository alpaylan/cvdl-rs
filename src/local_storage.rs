...
pub fn initiate_local_storage() {
    ...
    if let Ok(mut data_schemas_file) = std::fs::File::create_new(data_dir.join("data-schemas.json"))
    {
...
pub fn list_resumes() -> Vec<String> {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir().join("resumes");
...
pub fn list_data_schemas() -> Vec<String> {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir();
...
pub fn list_layout_schemas() -> Vec<String> {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir();
...
pub fn list_resume_layouts() -> Vec<String> {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir();
...
pub fn load_resume(resume_name: &str) -> ResumeData {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir().join("resumes");
...
pub fn load_data_schema(schema_name: &str) -> DataSchema {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir();
    let file = std::fs::File::open(data_dir.join("data-schemas.json")).unwrap();
    let data_schemas: Vec<DataSchema> = serde_json::from_reader(file).unwrap();
...
pub fn load_layout_schema(schema_name: &str) -> LayoutSchema {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir();
    let file = std::fs::File::open(data_dir.join("layout-schemas.json")).unwrap();
...
pub fn load_resume_layout(schema_name: String) -> ResumeLayout {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir();
    let file = std::fs::File::open(data_dir.join("resume-layouts.json")).unwrap();
...
pub fn save_resume(resume_name: &str, resume_data: &ResumeData) {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir().join("resumes");
...
pub fn save_data_schema(data_schema: &DataSchema) {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir();
    let file = std::fs::File::open(data_dir.join("data-schemas.json")).unwrap();
...
pub fn save_layout_schema(layout_schema: &LayoutSchema) {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir();
    let file = std::fs::File::open(data_dir.join("layout-schemas.json")).unwrap();
...
pub fn save_resume_layout(resume_layout: &ResumeLayout) {
    let project_dirs = ProjectDirs::from("com", "cvdl", "cvdl").unwrap();
    let data_dir = project_dirs.data_dir();
    let file = std::fs::File::open(data_dir.join("resume-layouts.json")).unwrap();
